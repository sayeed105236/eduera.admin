...
class Logger {
  ...
  private $tableName    = 'admin_logger';
  ...
  private $user_details   = false; //User ID
 ...
 /**
  ...
  public function log() {
    $data        = array(
      ...
      $this->table_fields['user_details']    => $this->user_details,
    );
  ...
  protected function _getQueryMaker() {
    ...
    if ($this->user_details)
      $this->ci->db->where($this->table_fields['user_details'], $this->user_details);
    if ($this->type)
